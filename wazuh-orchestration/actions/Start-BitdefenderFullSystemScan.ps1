<#
.SYNOPSIS
Starts a Bitdefender Full System Scan from a Wazuh Analytics action.

.DESCRIPTION
Discovers the local Full System Scan task identifier from Bitdefender's native
ondemandal.xml configuration, launches odscanui.exe with that task identifier,
and verifies that Bitdefender accepted the request.
...
$script:ScanType = 'Full System Scan'
$script:NormalizedTaskName = 'fullsystemscan'
$script:ActionSlug = 'start-full-system-scan'
